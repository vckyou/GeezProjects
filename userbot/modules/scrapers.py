...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}rbg` <Tautan ke Gambar> atau balas gambar apa pun (Peringatan: tidak berfungsi pada stiker.)\
...
CMD_HELP.update(
    {
        "ocr": f"**Plugin : **`ocr`\
        \n\n   :** `{cmd}ocr` <kode bahasa>\
        \n   : **Balas gambar atau stiker untuk mengekstrak teks media tersebut.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}barcode` <content>\
        \n   :** Buat Kode Batang dari konten yang diberikan.\
        \n\n  •  **Example :** `{cmd}barcode www.google.com`\
        \n\n   :** `{cmd}makeqr` <content>\
        \n   :** Buat Kode QR dari konten yang diberikan.\
