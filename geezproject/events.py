...
#
"""geezproject module for managing events. One of the main components of the geezproject."""
...
from geezproject import CMD_HANDLER, CMD_LIST, DEFAULT, DEVS, GEEZ2, GEEZ3, GEEZ4, GEEZ5, bot
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    ftext += "\n================================\n\n"
                    ftext += "--------BEGIN geezproject TRACEBACK LOG--------\n"
                    ftext += "\nTanggal : " + date
