...
from geezproject.utils import post_to_telegraph
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}nhentai` <code atau link>\
        \n  ❍▸ : **Melihat nhentai di telegra.ph XD\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}nhentai random`>\
        \n  ❍▸ : **Melihat nhentai di telegra.ph XD secara random\
    "
    }
)
