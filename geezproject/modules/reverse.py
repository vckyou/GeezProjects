...
#
""" geezproject module for reverse searching stickers and images on Google """
...
from geezproject.utils import googleimagesdownload
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}reverse` <jumlah>\
        \n  ↳ : **Balas gambar/stiker untuk melakukan pencarian terbalik di google/\
