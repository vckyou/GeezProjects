...
from geezproject.utils import bash, chrome, edit_or_reply, geez_cmd, progress
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}smd` <nama lagu>\
        \n  ❍▸ : **Mendowload lagu dari bot @SpotifyMusicDownloaderBot\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}smd now`\
        \n  ❍▸ : **Unduh penggunaan scrobble LastFM saat ini dari bot @SpotifyMusicDownloaderBot\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}net` <nama lagu>\
        \n  ❍▸ : **Mendowload lagu dari bot @WooMaiBot\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}net now`\
        \n  ❍▸ : **Unduh penggunaan scrobble LastFM saat ini dari bot @WooMaiBot\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}mhb` <Link Spotify/Deezer>\
        \n  ❍▸ : **Mendowload lagu dari Spotify atau Deezer dari bot @MusicsHunterBot\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}deez` <link spotify/deezer> FORMAT\
        \n  ❍▸ : **Mendowload lagu dari deezer atau spotify.\
