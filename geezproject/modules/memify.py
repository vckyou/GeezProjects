...
from geezproject.utils import runcmd, take_screen_shot
...
async def add_text_img(image_path, text):
    ...
    font = ImageFont.truetype(
        font="geezproject/utils/styles/FontLord.ttf",
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}mmf` Teks Atas ; Teks Bawah\
        \n  ❍▸ :** Balas Ke Sticker/Gambar/Gif, Gambar akan Di ubah jadi teks meme yang di tentukan\
