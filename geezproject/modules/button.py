...
from geezproject import BOT_USERNAME
from geezproject import CMD_HANDLER as cmd
from geezproject import CMD_HELP, tgbot
from geezproject.utils import edit_delete, geez_cmd, reply_id
...
@geez_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
