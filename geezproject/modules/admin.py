...
from geezproject import CMD_HELP, DEVS
...
async def spider(spdr):
    try:
        from geezproject.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    try:
        from geezproject.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        ...
        from geezproject.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
