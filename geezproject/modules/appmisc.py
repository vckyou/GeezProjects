# imported from github.com/ravana69/PornHub to geezproject by @heyworld
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}watch` <nama movie/tv>\
        \n  ↳ : **Untuk Mengetahui Detail Tentang Film.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}glitch` <Reply Ke Media>\
...
CMD_HELP.update(
    {
        "grab": f"**Plugin : **`grab`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}grab` <reply ke user yang ingin di grab>\
        \n  ↳ : **Balas Ke Pesan Pengguna Telegram dan Ketik `{cmd}grab` Atau `{cmd}grab <count>` Untuk Mengambil Foto Profil.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}grab` <jumlah foto>\
        \n  ↳ : **Untuk Mengambil Foto Profil dengan jumlah foto yg di inginkan.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove`\
        \n  ↳ : **Untuk Menganalisa user dari grup secara spesifik\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove d`\
        \n  ↳ : **Untuk mengkik user dari grup secara spesifik\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove y`\
        \n  ↳ : **Untuk Membanned Akun yang Terakhir Dilihat setahun yang lalu\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove m`\
        \n  ↳ : **Untuk Membanned Akun yang Terakhir Dilihat sebulan yang lalu\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove w`\
        \n  ↳ : **Untuk Membanned Akun yang Terakhir Dilihat seminggu yang lalu\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove o`\
        \n  ↳ : **Untuk Membanned Akun yang sedang offline\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove q`\
        \n  ↳ : **Untuk Membanned Akun yang sedang online\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove r`\
        \n  ↳ : **Untuk Membanned Akun yang terakhir dilihat\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove b`\
        \n  ↳ : **Untuk Membanned Bot yang ada di Grup chat\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}remove n`\
        \n  ↳ : **Untuk Membanned Akun yang Last Seen A Long Time Ago\
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}rnupload`\
        \n  ↳ : **Untuk Rename dan Upload, Balas Ke Media Dan Ketik .rnupload xyz.jpg\
    "
    }
)
