...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}sosmed` <link>\
        \n  ↳ : **Download Media Dari Pinterest / Tiktok / Instagram.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}dez` <link>\
        \n  ↳ : **Download Lagu Via Deezloader\
    "
    }
)
