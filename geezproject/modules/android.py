...
#
""" geezproject module containing commands related to android"""
...
from geezproject import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
...
@geez_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
@geez_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)")
...
CMD_HELP.update(
    {
        ...
        \n  ↳ : **Dapatkan info tentang nama kode atau model perangkat android. \
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}codename <brand> <device>`\
        \n  ↳ : **Cari nama kode perangkat android. \
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}pixeldl` **<download.pixelexperience.org>**\
        \n  ↳ : **Unduh ROM pengalaman piksel ke server bot pengguna Anda. \
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}specs <brand> <device>`\
