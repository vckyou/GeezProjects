...
#
""" geezproject module containing hash and encode/decode commands. """
...
CMD_HELP.update(
    {
        "hash": f"**Plugin : **`hash`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}hash`\
        \n  ❍▸ : **Untuk menemukan md5, sha1, sha256, sha512 dari string tersebut saat ditulis ke dalam file txt.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}base64` [en atau de]\
        \n  ❍▸ : **Temukan pengkodean base64 dari string yang diberikan atau pecahkan kodenya.\
