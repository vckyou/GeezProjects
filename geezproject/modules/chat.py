...
""" geezproject module containing userid, chatid and log commands"""
...
from geezproject import CMD_HELP, owner, DEVS
from geezproject.events import register
from geezproject.modules.ping import absen
from geezproject.utils import edit_delete, edit_or_reply, geez_cmd, get_user_from_event


@geez_cmd(pattern="userid$")
...
CMD_HELP.update(
    {
        "chat": f"**Plugin : **`chat`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}userid`\
        \n  ❍▸ : **untuk Mengambil ID obrolan saat ini\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}getbot`\
        \n  ❍▸ : **Dapatkan List Bot dalam grup caht.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}mutechat`\
        \n  ❍▸ : **membisukan Grup chat (membutuhkan hak admin).\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}unmutechat`\
        \n  ❍▸ : **Membuka Grup chat yang dibisukan (membutuhkan hak admin).\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}getbot`\
        \n  ❍▸ : **Dapatkan List Bot dalam grup caht.\
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}kickme`\
        \n  ❍▸ : **Keluar grup dengan menampilkan pesan Master has left this group, bye!!\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}leave`\
...
CMD_HELP.update(
    {
        "link": f"**Plugin : **`link`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}link` <username/userid> <opsional teks> (atau) Reply pesan .link <teks opsional>\
        \n  ❍▸ : **Membuat link permanen ke profil pengguna dengan teks ubahsuaian opsional.\
        \n  •  **Contoh : **{cmd}link @vckyaz Ganteng\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}getmember`\
        \n  ❍▸ : **Untuk Mengumpulkan Anggota dari group chat.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}addmember`\
        \n  ❍▸ : **Untuk Menambahkan Anggota ke group chat.\
        \n\n**Cara Menggunakannya:** \
