...
# FROM Man-geezproject <https://github.com/mrismanaziz/Man-geezproject>
...
@geez_cmd(pattern="(delayspam|dspam) ([\s\S]*)")
...
CMD_HELP.update(
    {
        "spam": f"**Plugin : **`spam`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}spam` <jumlah spam> <text>\
        \n  ↳ : **Membanjiri teks dalam obrolan!!\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}cspam` <text>\
        \n  ↳ : **Spam surat teks dengan huruf.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}sspam` <reply sticker>\
        \n  ↳ : **Spam sticker dari Seluruh isi Sticker Pack.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}wspam` <text>\
        \n  ↳ : **Spam kata teks demi kata.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}picspam` <jumlah spam> <link image/gif>\
        \n  ↳ : **Spam Foto Seolah-olah spam teks tidak cukup !!\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}delayspam` <detik> <jumlah spam> <text>\
        \n  ↳ : **Spam surat teks dengan huruf.\
