...
#
""" geezproject module for changing your Telegram profile details+ now u can steal personal details of user. """
...
from geezproject import CMD_HELP, SUDO_USERS, TEMP_DOWNLOAD_DIRECTORY, bot
...
CMD_HELP.update(
    {
        ...
        \n  **❍▸ : **Menganti Username Telegram.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.name` <nama depan> atau `.name` <Nama Depan> <Nama Belakang>\
        \n  **❍▸ : **Menganti Nama Telegram Anda.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.setbio` <bio baru>\
        \n  **❍▸ : **Untuk Mengganti Bio Telegram.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.setpfp`\
        \n  **❍▸ : **Balas Ke Gambar Ketik .setpfp Untuk Mengganti Foto Profil Telegram.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.delpfp` atau `.delpfp` <berapa profil>/<all>\
        \n  **❍▸ : **Menghapus Foto Profil Telegram.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.reserved`\
        \n  **❍▸ : **Menunjukkan nama pengguna yang dipesan oleh Anda.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.count`\
        \n  **❍▸ : **Menghitung Grup, Chat, Bot dll.\
        \n\n  •  **𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.info` <username> Atau Balas Ke Pesan Ketik `.data`\
