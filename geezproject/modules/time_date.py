...
#
""" geezproject module for getting the date
    and time of any country or the geezproject server.  """
...
from geezproject import CMD_HELP, COUNTRY, TZ_NUMBER, bot
...
async def time_func(tdata):
    ...
    2. The default geezproject country(set it by using .settime),
    3. The server where the geezproject runs.
    """
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}time` <country name/code> <timezone number>\
        \n  ↳ : **Dapatkan waktu suatu negara. Jika suatu negara memiliki beberapa zona waktu, itu akan mencantumkan semuanya dan memungkinkan Anda memilihnya.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}date` <country name/code> <timezone number>\
        \n  ↳ : **Dapatkan tanggal suatu negara. Jika suatu negara memiliki beberapa zona waktu, itu akan mencantumkan semuanya dan memungkinkan Anda memilihnya.\
    "
    }
)
