...
@geez_cmd(pattern="(task|truth|dare)(?: |$)([1-5]+)?$")
async def tod(event):
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}truth`\
        \n  ❍▸ : **Memberikan anda tantangan kejujuran secara random.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}dare`\
        \n  ❍▸ : **Memberikan anda tantangan Keberanian secara random.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}task`\
        \n  ❍▸ : **Untuk Memberikan anda tantangan secara random.\
    "
    }
)
