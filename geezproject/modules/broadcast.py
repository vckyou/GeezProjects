...
from geezproject import CMD_HELP, LOGS, bot
from geezproject.events import geez_cmd
from geezproject.modules.sql_helper import broadcast_sql as sql
from geezproject.utils import parse_pre
...
CMD_HELP.update(
    {
        ...
        \n   : **akan mengirim pesan balasan ke semua obrolan dalam kategori yang diberikan.\
        \n\n   :** `{cmd}fwdto` <category_name>\
        \n   : **akan meneruskan pesan yang dibalas ke semua obrolan di kategori berikan. \
        \n\n   :** `{cmd}addto` <category name>\
        \n   : **Ini akan menambahkan obrolan / pengguna / saluran ini ke kategori nama yang diberikan. \
        \n\n   :** `{cmd}rmfrom` <category name>\
        \n   : **Untuk menghapus Obrolan / pengguna / saluran dari nama kategori yang diberikan. \
        \n\n   :** `{cmd}bclist` <category_name>\
        \n   : **Akan menampilkan daftar semua obrolan dalam kategori yang diberikan. \
        \n\n   :** `{cmd}bclistall`\
        \n   : **Akan menampilkan daftar semua nama kategori. \
        \n\n   :** `{cmd}frmfrom` <category_name/chat_id>\
        \n   : **Untuk memaksa menghapus chat_id yang diberikan dari nama kategori yang diberikan berguna ketika Anda meninggalkan obrolan itu atau melarang Anda di sana \
        \n\n   :** `{cmd}delc` <category_name>\
        \n   : **Menghapus kategori sepenuhnya di database \
    "
    }
)
