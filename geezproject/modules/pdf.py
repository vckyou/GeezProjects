    ...
    try:
        async with bot.conversation(chat) as conv:
            try:
                ...
                filename = await conv.send_message("GeezProjects")
...
CMD_HELP.update(
    {
        "pdf": f"**Plugin : **`pdf`\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}pdf` <reply text>\
        \n  ↳ : **Untuk Mengconvert teks menjadi file PDF menggunakan @office2pdf_bot\
    "
    }
)
