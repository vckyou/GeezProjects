...
from geezproject import DEFAULT as me
from geezproject.events import register as own_cmd
from geezproject.modules.ping import absen
from geezproject.utils import edit_or_reply, geez_cmd


@geez_cmd(pattern="bulan$")
async def _(event):
