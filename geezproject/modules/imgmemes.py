...
from geezproject.utils import bash, deEmojify
...
async def FakeGoogleSearch(event):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("geezproject/utils/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("geezproject/utils/styles/ProductSans-Light.ttf", 23)
