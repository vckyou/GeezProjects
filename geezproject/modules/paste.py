...
#
"""geezproject module containing commands for interacting with dogbin(https://del.dog)"""
...
from geezproject.utils.pastebin import PasteBin


@geez_cmd(pattern="paste(?: (-d|-n|-h|-k|-s)|$)?(?: ([\s\S]+)|$)")
