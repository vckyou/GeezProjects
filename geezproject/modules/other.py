# Copyright (c) 2021 Man-geezproject
# Created by mrismanaziz
# FROM <https://github.com/mrismanaziz/Man-geezproject>
# t.me/SharingUserbot & t.me/Lunatic0de
#
# Thanks To Ultroid <https://github.com/TeamUltroid/Ultroid>
# Thanks To Geez-geezproject <https://github.com/vckyou/Geez-geezproject>
...
CMD_HELP.update(
    {
        "view": f"**Plugin : **`view`\
        \n\n   :** `{cmd}view` <reply ke link>\
        \n   : **Untuk Melihat isi web dengan instan view telegraph.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n   : **Untuk mengirim chat dengan menggunakan geezproject.\
        \n\n   :** `{cmd}fwdreply` <username> <text>\
        \n   : **Untuk meneruskan chat yang di reply dengan membalasnya ke pc.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}sendbot` <username bot> <text>\
        \n   : **Untuk mengirim ke bot dan mendapatkan respond chat dengan menggunakan geezproject.\
    "
    }
)
...
CMD_HELP.update(
    {
        "tmsg": f"**Plugin : **`tmsg`\
        \n\n   :** `{cmd}tmsg` <username/me>\
        \n   : **Untuk Menghitung total jumlah chat yang sudah dikirim.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}getlink`\
        \n   : **Untuk Mendapatkan link invite grup chat.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}unbanall`\
        \n   : **Untuk Menghapus Semua Pengguna yang dibanned di Daftar Banned GC.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}limit`\
        \n   : **Untuk Mengecek akun anda sedang terkena limit atau tidak dengan menggunakan @spambot.\
    "
    }
)
