...
#
""" geezproject module for getting the weather of a city. """
...
from geezproject import OPEN_WEATHER_MAP_APPID as OWM_API
from geezproject import WEATHER_DEFCITY, bot
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}weather` <city> or `.weather` <city>, <country name/code>\
        \n  •  **Function : **Untuk Mendapat informasi cuaca kota.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 : **`{cmd}weather anon` \
