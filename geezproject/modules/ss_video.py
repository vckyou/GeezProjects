...
from geezproject.utils import bash, edit_or_reply, geez_cmd, progress


@geez_cmd(pattern="ssvideo(?: |$)(.*)")
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}ssvideo <frame>`\
        \n  ↳ : **Untuk Screenshot video dari frame per frame\
    "
    }
)
