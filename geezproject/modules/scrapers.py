...
""" geezproject module containing various scrapers. """
...
from geezproject.modules.upload_download import get_video_thumb
from geezproject.utils import (
    chrome,
    edit_delete,
    edit_or_reply,
...
from geezproject.utils.FastTelethon import upload_file
...
@geez_cmd(pattern=r"lang (tr|tts) (.*)")
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Menerjemahkan teks ke ucapan untuk bahasa yang disetel. \
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Command :** `{cmd}rbg` <Tautan ke Gambar> atau balas gambar apa pun (Peringatan: tidak berfungsi pada stiker.)\
        \n  •  **Fungsi : **Menghapus latar belakang gambar, menggunakan API remove.bg\
    "
    }
)
...
CMD_HELP.update(
    {
        "ocr": f"**Plugin : **`ocr`\
        \n\n  •  **Command :** `{cmd}ocr` <kode bahasa>\
        \n  •  **Fungsi : **Balas gambar atau stiker untuk mengekstrak teks media tersebut.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Untuk Melakukan pencarian di google (default 5 hasil pencarian)\
        \n  •  **Flags :** `-l` **= Untuk jumlah hasil pencarian.**\
        \n  •  **Example :** `{cmd}google -l4 searching` atau `{cmd}google searching`\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Melakukan pencarian di Wikipedia.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Melakukan pencarian gambar di Google dan menampilkan 15 gambar.\
    "
    }
)
...
CMD_HELP.update(
    {
        "ytdl": f"**Plugin : **`ytdl`\
        \n\n  •  **Command :** `{cmd}yt` <jumlah> <query>\
        \n  •  **Fungsi : **Melakukan Pencarian YouTube. Dapat menentukan jumlah hasil yang dibutuhkan (default adalah 5)\
        \n\n  •  **Command :** `{cmd}ytaudio` <url>\
        \n  •  **Fungsi : **Untuk Mendownload lagu dari YouTube dengan link.\
        \n\n  •  **Command :** `{cmd}ytvideo` <quality> <url>\
        \n  •  **Quality : **`144`, `240`, `360`, `480`, `720`, `1080`, `2160`\
        \n  •  **Fungsi : **Untuk Mendownload video dari YouTube dengan link.\
        \n\n  •  **Command :** `{cmd}song` <nama lagu>\
        \n  •  **Fungsi : **Untuk mendownload lagu dari youtube dengan nama lagu.\
        \n\n  •  **Command :** `{cmd}vsong` <nama lagu>\
        \n  •  **Fungsi : **Untuk mendownload Video dari youtube dengan nama video.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Mengonversi berbagai mata uang untuk Anda.\
    "
    }
)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Fungsi : **Melakukan pencarian di Urban Dictionary.\
    "
    }
)
