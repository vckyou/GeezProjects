...
from geezproject import BIO_PREFIX, BOTLOG_CHATID
...
@geez_cmd(pattern="lastbio (on|off)")
...
@geez_cmd(pattern="lastlog (on|off)")
...
CMD_HELP.update(
    {
        ...
        \n\n   :** `{cmd}lastfm`\
        \n   : **Menampilkan trek scrobbling saat ini atau scrobble terbaru jika tidak ada yang diputar.\
        \n\n   :** `{cmd}lastbio` <on/off>\
        \n   : **Mengaktifkan / Menonaktifkan pemutaran last.fm saat ini ke bio.\
        \n\n   :** `{cmd}lastlog` <on/off>\
        \n   : **Mengaktifkan / Menonaktifkan bio logging last.fm di grup bot-log.\
    "
    }
)
