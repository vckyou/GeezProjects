...
from geezproject import BOT_USERNAME, BOTLOG_CHATID
from geezproject import CMD_HANDLER as cmd
from geezproject import CMD_HELP, bot, tgbot, user
from geezproject.modules.sql_helper.bot_blacklists import (
    add_user_to_bl,
    check_is_black_list,
    get_all_bl_users,
    rem_user_from_bl,
)
from geezproject.modules.sql_helper.bot_pms_sql import get_user_id
...
@geez_cmd(pattern="(set|reset) pmbot(?: |$)(\\w*)")
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}set pmbot` <balas ke pesan>\
        \n  •  **Function : **Mengcustom Pesan start pmbot.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}reset pmbot`\
