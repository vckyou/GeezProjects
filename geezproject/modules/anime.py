...
@geez_cmd(pattern="a(kaizoku|kayo) ?(.*)")
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}anilist` **<nama anime>**\
        \n  ↳ : **Mencari informasi anime dari anilist\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}anime` **<nama anime>**\
        \n  ↳ : **Mencari infomasi anime.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}manga` **<manga name>**\
        \n  ↳ : **Menari informasi manga.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}akaizoku` atau `.akayo` **<nama anime>**\
        \n  ↳ : **Mencari anime dan memberikan link tautan Unduh Anime.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}char` **<nama character anime>**\
        \n  ↳ : **Mencari informasi karakter anime.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}upcoming`\
        \n  ↳ : **Mencari informasi Anime yang akan datang.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}scanime` **<nama anime>** atau `.sanime` **<nama anime>**\
        \n  ↳ : **Mencari anime\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}smanga` **<manga>**\
        \n  ↳ : **Untuk mencari akun terhapus dalam grup\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}whatanime` **<Reply Gambar scene Anime.>**\
